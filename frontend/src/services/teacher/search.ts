...
interface ISearchTeachersByTermResponse {
...
const searchTeachersByTerm = async (term: string): Promise<ISearchTeachersByTermResponse> => {
    ...
    const config = {
        ...
        url: URL + `/professor/search?term=${term}`,
        method: 'get'
    };
...
export default searchTeachersByTerm;