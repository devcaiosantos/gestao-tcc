...
interface IRemoveGoogleCredentialsResponse {
...
const removeGoogleCredentials = async (): Promise<IRemoveGoogleCredentialsResponse> => {
...
export default removeGoogleCredentials;